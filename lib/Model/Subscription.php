...
class Subscription implements ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['test'] = isset($data['test']) ? $data['test'] : false;
        $this->container['amount'] = isset($data['amount']) ? $data['amount'] : null;
        $this->container['quantity'] = isset($data['quantity']) ? $data['quantity'] : null;
        $this->container['timezone'] = isset($data['timezone']) ? $data['timezone'] : null;
        $this->container['created'] = isset($data['created']) ? $data['created'] : null;
        $this->container['renewing'] = isset($data['renewing']) ? $data['renewing'] : false;
        ...
        $this->container['is_cancelled'] = isset($data['is_cancelled']) ? $data['is_cancelled'] : false;
        $this->container['in_trial'] = isset($data['in_trial']) ? $data['in_trial'] : false;
        $this->container['has_started'] = isset($data['has_started']) ? $data['has_started'] : false;
        ...
        $this->container['payment_method_added'] = isset($data['payment_method_added']) ? $data['payment_method_added'] : false;
